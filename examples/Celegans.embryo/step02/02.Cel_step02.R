...
new_identity_TSNE<-Cel.exp.filter.tSNE
new_identity_TSNE<-RenameIdents(new_identity_TSNE, "0"="10+19", "1"="4", "2"="0", "3"="11", "4"="2", "5"="8", "6"="17", "7"="14+15", "8"="13", "9"="1", "10"="18", "11"="6", "12"="9", "13"="5", "14"="7", "15"="3", "16"="16", "17"="12", "18"="20")
pdf("Cel.step02.09.DimPlot.tSNE.select.pdf", height=5, width=6)
DimPlot(new_identity_TSNE, reduction = "tsne", cols=c(color_list[11], color_list[5], color_list[1], color_list[12], color_list[3], color_list[9], color_list[18], color_list[15], color_list[14], color_list[2], color_list[19], color_list[7], color_list[10], color_list[6], color_list[8], color_list[4], color_list[17], color_list[13], color_list[21]))
dev.off()
