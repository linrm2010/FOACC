...
new_identity_TSNE<-pbmc.tSNE
new_identity_TSNE<-RenameIdents(new_identity_TSNE, "0"="0", "1"="2", "2"="3", "3"="1", "4"="5", "5"="6", "6"="4", "7"="7", "8"="8")
pdf("pbmc.step02.09.DimPlot.tSNE.select.pdf", height=3.2, width=4)
DimPlot(new_identity_TSNE, reduction = "tsne", cols=c(color_list[1], color_list[3], color_list[4], color_list[2], color_list[6], color_list[7], color_list[5], color_list[8], color_list[9]))
dev.off()
...
pdf("pbmc.step02.10.VlnPlot.pdf", height=4, width=8)
VlnPlot(pbmc.tSNE, features = c("ENSG00000105374", "ENSG00000163737"), slot = "counts", log = TRUE)
dev.off()

#pdf("pbmc.step02.11.FeaturePlot.pdf", height=7, width=8)
#FeaturePlot(pbmc.tSNE, features = c("MS4A1", "GNLY", "CD3E", "CD14", "FCER1A", "FCGR3A", "LYZ", "PPBP", "CD8A"))
#dev.off()
