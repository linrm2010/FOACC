...
pdf("pbmc.01.FeatureScatter.pdf", height=3.5, width=8)
...
pdf("pbmc.02.VariableFeaturePlot.pdf", height=3, width=10)
...
pdf("pbmc.03.VizDimLoadings.pdf", height=6, width=8)
VizDimLoadings(pbmc, dims = 1:2, reduction = "pca")
dev.off()

pdf("pbmc.04.DimPlot.pdf", height=6, width=6)
DimPlot(pbmc, reduction = "pca")
dev.off()

pdf("pbmc.05.DimHeatmap.pdf", height=16, width=8)
...
pdf("pbmc.06.JackStrawPlot.pdf", height=6, width=8)
JackStrawPlot(pbmc, dims = 1:15)
dev.off()

pdf("pbmc.07.ElbowPlot.pdf", height=5, width=5)
ElbowPlot(pbmc)
dev.off()
...
pdf("pbmc.08.DimPlot.UMAP.pdf", height=4, width=5)
DimPlot(pbmc.UMAP, reduction = "umap")
dev.off()

pdf("pbmc.09.DimPlot.tSNE.pdf", height=4, width=5)
...
pdf("pbmc.10.VlnPlot.pdf", height=4, width=8)
VlnPlot(pbmc.UMAP, features = c("NKG7", "PF4"), slot = "counts", log = TRUE)
dev.off()

pdf("pbmc.11.FeaturePlot.pdf", height=7, width=8)
...
pdf("pbmc.12.DoHeatmap.pdf", height=8, width=8)
