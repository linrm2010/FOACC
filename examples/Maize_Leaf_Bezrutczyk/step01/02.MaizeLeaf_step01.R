...
pdf("MaizeLeaf.step01.01.VlnPlot.pdf", height=6, width=8)
...
pdf("MaizeLeaf.step01.01.VlnPlot.filter.pdf", height=6, width=4)
VlnPlot(MaizeSample.exp.filter, features = c("nFeature_RNA", "nCount_RNA", "percent.mt", "percent.chl"), ncol = 4)
dev.off()
...
pdf("MaizeLeaf.step01.02.VariableFeaturePlot.pdf", height=5, width=12)
...
pdf("MaizeLeaf.step01.03.VizDimLoadings.pdf", height=6, width=8)
VizDimLoadings(MaizeSample.exp.filter, dims = 1:2, reduction = "pca")
dev.off()

pdf("MaizeLeaf.step01.04.DimHeatmap.pdf", height=16, width=8)
...
pdf("MaizeLeaf.step01.05.JackStrawPlot.pdf", height=6, width=8)
JackStrawPlot(MaizeSample.exp.filter, dims = 1:30)
dev.off()

pdf("MaizeLeaf.step01.06.ElbowPlot.pdf", height=5, width=5)
ElbowPlot(MaizeSample.exp.filter, ndims = 30)
dev.off()

MaizeSample.exp.filter <- FindNeighbors(MaizeSample.exp.filter, dims = 1:30)

MaizeSample.exp.filter <- FindClusters(MaizeSample.exp.filter, resolution = 0.5)

MaizeSample.exp.filter.UMAP <- RunUMAP(MaizeSample.exp.filter, dims = 1:30)

MaizeSample.exp.filter.tSNE <- RunTSNE(MaizeSample.exp.filter, dims = 1:30)

pdf("MaizeLeaf.step01.07.DimPlot.UMAP.pdf", height=3.5, width=5)
DimPlot(MaizeSample.exp.filter.UMAP, reduction = "umap")
#DimPlot(MaizeSample.exp.filter.UMAP, reduction = "umap", label = TRUE)
dev.off()

pdf("MaizeLeaf.step01.08.DimPlot.tSNE.pdf", height=3.5, width=5)
...
pdf("MaizeLeaf.step01.08.DimPlot.tSNE.select.pdf", height=3, width=3.7)
DimPlot(MaizeSample.exp.filter.tSNE, reduction = "tsne", cols=color_list)
dev.off()
...
pdf("MaizeLeaf.step01.09.DoHeatmap.pdf", height=8.5, width=8.5)
DoHeatmap(MaizeSample.exp.filter.tSNE, features = top10$gene) + NoLegend()
dev.off()

saveRDS(MaizeSample.exp.filter, file = "MaizeLeaf_step01.rds")

write.table(WhichCells(MaizeSample.exp.filter.tSNE, idents="0"), "Cells.step01.maize01.ID.txt", sep="\t", quote = FALSE)
write.table(WhichCells(MaizeSample.exp.filter.tSNE, idents="1"), "Cells.step01.maize02.ID.txt", sep="\t", quote = FALSE)
write.table(WhichCells(MaizeSample.exp.filter.tSNE, idents="2"), "Cells.step01.maize03.ID.txt", sep="\t", quote = FALSE)
write.table(WhichCells(MaizeSample.exp.filter.tSNE, idents="3"), "Cells.step01.maize04.ID.txt", sep="\t", quote = FALSE)
write.table(WhichCells(MaizeSample.exp.filter.tSNE, idents="4"), "Cells.step01.maize05.ID.txt", sep="\t", quote = FALSE)
write.table(WhichCells(MaizeSample.exp.filter.tSNE, idents="5"), "Cells.step01.maize06.ID.txt", sep="\t", quote = FALSE)
write.table(WhichCells(MaizeSample.exp.filter.tSNE, idents="6"), "Cells.step01.maize07.ID.txt", sep="\t", quote = FALSE)
write.table(WhichCells(MaizeSample.exp.filter.tSNE, idents="7"), "Cells.step01.maize08.ID.txt", sep="\t", quote = FALSE)
write.table(WhichCells(MaizeSample.exp.filter.tSNE, idents="8"), "Cells.step01.maize09.ID.txt", sep="\t", quote = FALSE)
write.table(WhichCells(MaizeSample.exp.filter.tSNE, idents="9"), "Cells.step01.maize10.ID.txt", sep="\t", quote = FALSE)
